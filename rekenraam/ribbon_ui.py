...
class Ribbon(QtWidgets.QFrame):
    def __init__(self, parent):
        ...
        self.setSizePolicy(QtWidgets.QSizePolicy.Ignored, 4)
        ribbon_frame_layout = QtWidgets.QVBoxLayout()
        ribbon_frame_layout.setSpacing(0)
        ribbon_frame_layout.setContentsMargins(0, 0, 0, 0)
        self.setLayout(ribbon_frame_layout)

        ribbon_frame_layout.addItem(QtWidgets.QSpacerItem(0, 10))
        ribbon_tabs = RibbonTabs(self, parent)
        ribbon_frame_layout.addWidget(ribbon_tabs)
        ribbon_frame_layout.addItem(QtWidgets.QSpacerItem(0, 0))
...
class RibbonTabs(QtWidgets.QTabWidget):
    def __init__(self, parent, main_window):
        ...
        super(RibbonTabs, self).__init__()
